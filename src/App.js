...
function App() {
  ...
  if (window.location.pathname === '/dashboard' | window.location.pathname === '/dashboard/create-post' | window.location.pathname === '/dashboard/add-category') {
    return (
      <Router />
    )
  } else {
    return (
      ...
      <>
        <div className="site-wrapper header-1" style={{ transform: "none" }}>
          <HeaderController headerData={header} monsterSearch={state} siteLogo={siteLogo} siteTitle={siteTitle} siteLogo2={siteLogo2} />
