                ...
                <div className="row">
                  <div className="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li>
                        <a href="file-dashboard.html">File Manager</a>
                      </li>
                      <li>
                  ...
                  <div className="col-lg-3 col-md-6 col-sm-12">
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li>
                        <a
                          href="http://thememakker.com/admin-templates/"
                          target="_blank"
                        >
                          Admin Templates
                        </a>
                      ...
                      <li>
                        <a
                          href="http://thememakker.com/portfolio/"
                          target="_blank"
                        >
                          Portfolio
                        </a>
        ...
        <ul className="menu_list">
          ...
          <li>
            <a href="contact.html" title="Contact List">
              <i className="zmdi zmdi-account-box-phone" />
            </a>
          </li>
          <li>
            <a href="chat.html">
                ...
                <ul className="list-unstyled menu">
                  ...
                  <li>
                    <a href="blog-dashboard.html">
                      <i className="zmdi zmdi-blogger" />
                      <span>Blog</span>
                    </a>
                  </li>
                  <li>
                    <a href="javascript:void(0)">
                      <i className="zmdi zmdi-arrows" />
                      <span>Notes</span>
                    </a>
                  </li>
                  <li>
                    ...
                    <a href="javascript:void(0);">
                      <div className="media">
                        ...
                        <div className="media-body">
                          <span className="name">
                            Alexander <small className="time">35min ago</small>
                          </span>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      <div className="media">
                        ...
                        <div className="media-body">
                          <span className="name">
                            Grayson <small className="time">1hr ago</small>
                          </span>
                          <p className="message">New tasks needs to be done</p>
                        </div>
                      </div>
                  ...
                  <li>
                    <a href="javascript:void(0);">
                      <div className="media">
                        ...
                        <div className="media-body">
                          <span className="name">
                            Sophia <small className="time">31min ago</small>
                          </span>
                          <p className="message">New tasks needs to be done</p>
                        </div>
                      </div>
              ...
              <div className="body">
                <ul className="notification list-unstyled">
                  ...
                  <li>
                    ...
                    <p>
                      <a href="javascript:void(0)">Docs.doc</a>
                    </p>
                  ...
                  <li>
                    ...
                    <p>
                      <a href="javascript:void(0)">AdminX BS4</a>
                    </p>
          ...
          <div className="tab-content slim_scroll">
            <div className="tab-pane slideRight active" id="setting">
              ...
              <div className="card">
                <div className="header">
                  <h2>
                    <strong>Left</strong> Menu
                  </h2>
                </div>
                <div className="body theme-light-dark">
                  <button className="t-dark btn btn-primary btn-round btn-block">
                    Dark
                  </button>
                </div>
              </div>
            ...
            <div className="tab-pane slideLeft" id="activity">
              <div className="card activities">
                <div className="header">
                  <h2>
                    <strong>Recent</strong> Activity Feed
                  </h2>
                </div>
                <div className="body">
            ...
            <div className="row">
              <div className="col-lg-5 col-md-5 col-sm-12">
                ...
                <ul className="breadcrumb p-l-0 p-b-0">
                  ...
                  <li className="breadcrumb-item">
                    <Link to="/dashboard/home">
                      {getLocation.pathname.split("/")[1]}
                    </Link>
                  </li>
                  <li className="breadcrumb-item active">
                    {getLocation.pathname.split("/")[2]}
                  </li>
                </ul>
              </div>
