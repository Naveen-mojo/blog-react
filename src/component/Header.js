                                ...
                                <div className="col-xs-6">
                                    <div className="site-logo header-logo text-center">
                                        <a href="/">
                                            <span className="logo-wrapper">
                                                <h3>{props.siteTitle}</h3>
                                                {/* <img className="logo-light-mode" src={`${props.siteLogo}` ? `${props.siteLogo}` : `${props.siteTitle}`} alt={`${props.siteTitle}`} width={340} />
                                                <img className="logo-dark-mode" src={logo2} alt="Logo" width={340} /> */}
                                            </span>  </a>
                                    </div>{/* .site-logo */}              </div>
                            ...
                            <div className="header-branding header-branding--mobile mobile-header__section text-left">
                                <div className="header-logo header-logo--mobile flexbox__item text-left">
                                    <Link to="/">
                                        {/* begin logo */}
                                        <span className="logo-wrapper">
                                            <img className="logo-light-mode" src={`${props.siteLogo}` ? `${props.siteLogo}` : `${props.siteTitle}`} alt={`${props.siteTitle}`} />
                                            <img className="logo-dark-mode" src={`${props.siteLogo2}` ? `${props.siteLogo2}` : `${props.siteTitle}`} alt={`${props.siteTitle}`} />
                                        </span>{/* .logo-wrapper */}
                                        {/* end logo  */}
                                    </Link>
                                </div>
                                ...
                                <div className="col-xs-6">
                                    <div className="site-logo header-logo text-center">
                                        <a href="/">
                                            <span className="logo-wrapper">
                                                <img className="logo-light-mode" src={`${props.siteLogo}` ? `${props.siteLogo}` : `${props.siteTitle}`} alt={`${props.siteTitle}`} width={340} />
                                                <img className="logo-dark-mode" src={`${props.siteLogo2}` ? `${props.siteLogo2}` : `${props.siteTitle}`} alt={`${props.siteTitle}`} width={340} />
                                            </span>  </a>
                                    </div>{/* .site-logo */}              </div>
                                <div className="col-xs-3 text-right">
                                    <a href="#subscribe-modal" className="btn btn-default" data-toggle="modal" data-target="#subscribe-modal">
