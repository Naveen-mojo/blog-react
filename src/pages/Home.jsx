                                                                ...
                                                                <div className="post__text-wrap">
                                                                    <div className="post__text-inner flexbox-wrap flexbox-wrap-direction-column">
                                                                        <div className="post__meta date-stamp">
                                                                            <Link className="cat-5 post__cat cat-theme" to={`/${curValue.PostSlug}`}>Review</Link>
                                                                            <span className="time-wrap"><time className="time published" dateTime={moment(curValue.CreationDate).format('MMMM Do YYYY, h:mm:ss a')} title={moment(curValue.CreationDate).format('MMMM Do YYYY , h:mm:ss a')}>
                                                                                {moment(curValue.CreationDate).format('Do')}<span>{moment(curValue.CreationDate).format('MMMM')}</span>
                                                                            </time></span>
                                                                        </div>
